...
<button type="button" class="btn btn-outline-primary">Categorías</button>
<button type="button" class="btn btn-outline-primary">Libros</button>
<button type="button" class="btn btn-outline-primary">Prestamos</button>
</div>
